...
|---|---|---|---|---|---|---|
| 0 | **🔥 Hotfixes** | 🔥 ship first | 3 P0 production failures | 2026-05-15 | — | hotfix-1: GET /uploads/serve/{filename} is unauthenticated (DPDP P0). hotfix-2: FeeCollection.js receipt download calls non-existent endpoint (404). hotfix-3: leave approval allows any admin sub_category — fix with require_owner_or_principal. Ship ALL THREE before Part 5 starts. |
