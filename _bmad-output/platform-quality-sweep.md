...
| 3 | **Owner role (vertical)** | ✅ done | 12/12 extracted FRs verified | 2026-05-15 | 2026-05-15 | Part 3 owner hardening and QA closed. Tenant scoping, announcement moderation, auth dependency migration, fee-sync field whitelisting, frontend auth header consistency, AI tool scoping, owner-only role matrix, and facility confirm-resolution lifecycle verified. Backend suite now collects 367 tests and passes 367/367; frontend build passes with pre-existing warnings. |
