...
const ALL_TOOLS = [
  ...
  { id: 'asset-custody',          name: 'Asset Custody',         subtitle: 'Issue and return assets',   icon: Package,       roles: ['owner','admin'] },
  { id: 'resource-calendar',      name: 'Resource Calendar',     subtitle: 'Rooms, labs and equipment', icon: CalendarDays, roles: ['owner','admin','teacher'] },
  { id: 'procurement-inventory',  name: 'Procurement',           subtitle: 'Orders and stock',         icon: Package,       roles: ['owner','admin'] },
  { id: 'library-circulation',    name: 'Library',               subtitle: 'Catalog and loans',        icon: BookOpen,      roles: ['owner','admin','teacher','student'] },
  { id: 'accounting-periods',     name: 'Accounting Periods',    subtitle: 'Financial posting locks',  icon: CalendarDays,  roles: ['owner','admin'] },
  { id: 'payroll-manager',        name: 'Payroll & Payslips',    subtitle: 'Corrections and slips',    icon: FileText,      roles: ['owner','admin'] },
  { id: 'my-payslips',            name: 'My Payslips',           subtitle: 'Salary records',           icon: FileText,      roles: ['teacher'] },
  { id: 'quiz-manager',           name: 'Quiz Manager',          subtitle: 'Author and publish quizzes', icon: PenTool,     roles: ['owner','admin','teacher'] },
  { id: 'guardian-portal',        name: 'Guardian Portal',       subtitle: 'Wards, fees and academics', icon: Users,        roles: ['parent'] },
  ...
  { id: 'student-leave-request', name: 'Student Leave',   subtitle: 'Request and track leave',   icon: CalendarDays,   roles: ['student'] },
