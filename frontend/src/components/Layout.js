...
const loadTool = async (toolId) => {
  ...
  const OWNERS = ['school-pulse','fee-collection','student-strength','data-import','attendance-overview','staff-attendance-tracker','financial-reports','announcement-broadcaster','admission-funnel','staff-leave-manager','staff-performance','ai-health-report','smart-alerts','expense-tracker','complaint-tracker','custom-report-builder','board-report','smart-fee-defaulter','attendance-alerts'];
