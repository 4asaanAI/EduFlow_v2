...
const TOOLS_BY_ROLE = {
  owner: [
    ...
    { id: 'commercial-operations', name: 'Legal Entities & Admissions', subtitle: 'Entities & admission leads', icon: IndianRupee, color: '#34d399' },
    { id: 'announcement-broadcaster', name: 'Announcements', subtitle: 'Broadcast messages', icon: Megaphone, color: '#fbbf24' },
    { id: 'admissions', name: 'Admissions', subtitle: 'Enquiries, applications and pipeline', icon: UserPlus, color: '#4f8ff7' },
  ...
  admin: [
    ...
    { id: 'admissions', name: 'Admissions', subtitle: 'Enquiries, applications and pipeline', icon: UserPlus, color: '#a78bfa' },
