...
| Field | Value |
|-------|-------|
| **Agreement type** | Microsoft Customer Agreement (MCA) |
| **Agreement reference** | 02B90386C314 |
| **Microsoft entity** | Microsoft Corporation (India) Pvt. Ltd., DLF Downtown, Level 8, Block 2, DLF Phase-3, Sector 25A, Gurugram – 122002 |
| **DPA coverage** | Incorporated by reference into MCA (General Terms, Section 1) |
| **Azure OpenAI resource region** | Central India (`centralindia`) |
| **Confirmed by** | Abhimanyu |
