...
def test_accountant_can_create_fee_structure(client):
    resp = client.post(
        "/api/fees/structures",
        json={"name": "Test"},
...
def test_principal_can_create_fee_structure(client):
    resp = client.post(
        "/api/fees/structures",
        json={"name": "Test"},
...
def test_accountant_can_update_fee_structure(client, fake_db):
    fake_db.fee_structures.docs = [
